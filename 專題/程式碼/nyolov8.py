...
def b(opt, queue,v8_result, v8_result_detail,counter):
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    #三角錐
    model1 = YOLO("C:/Users/USER/Desktop/project/button/button/best_cones.pt")
    #工程車
    model2 = YOLO("C:/Users/USER/Desktop/project/button/button/best_mix.pt")
    #紐澤西圍欄
    model3 = YOLO("C:/Users/USER/Desktop/project/button/button/best_barrie.pt")
    model1.to(device)
    model2.to(device)
    model3.to(device)
